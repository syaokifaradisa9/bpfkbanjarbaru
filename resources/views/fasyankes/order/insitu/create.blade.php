...
@section('sub-content')
  <div class="card">
    ...
    <form action="{{ route('fasyankes.order.insitu.store') }}" method="POST" enctype='multipart/form-data' id="form-insitu-order">
      @csrf
...
@section('sub-js-extends')
  ...
  <script src="{{ asset('js/order/insitu/fasyankes/form-submit-validation.js') }}"></script>
@endsection
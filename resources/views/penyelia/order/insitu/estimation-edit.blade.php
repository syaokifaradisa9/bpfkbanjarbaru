...
@section('sub-content')
  <div class="card">
    ...
    <form action="{{ route('penyelia.order.insitu.update_estimation', ['id' => $order->id]) }}" method="POST">
        @csrf
        @method('PUT')
...
@section('sub-js-extends')
  <script src="{{ asset('js/order/insitu/validation/estimation-validation.js') }}"></script>
@endsection
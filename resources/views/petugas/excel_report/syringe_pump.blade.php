    ...
    <body>
        ...
        <div id="content">
                        ...
                        <table class="result-table">
                            ...
                            @for ($i = 1; $i <= 3; $i++)
                                <tr>
                                    ...
                                    <td>{{ $data->getCell('C'.(26 + $i))->getFormattedValue() }}</td>
                                    <td class="text-center symbol">{{ $data->getCell('H'.(26 + $i))->getFormattedValue()." ".$data->getCell('I'.(26 + $i))->getFormattedValue() }}</td>
                                    <td class="text-center symbol">{{ $data->getCell('J'.(26 + $i))->getFormattedValue() }}</td>
                                </tr>
                            @endfor
                        </table>
                    </td>
                        ...
                        <table class="result-table">
                            ...
                            @for ($i = 1; $i <= 4; $i++)
                                <tr>
                                    ...
                                    @if ($i == 1)
                                        <td class="text-center" rowspan="4">{{ $data->getCell('H'.($i + 33))->getFormattedValue() }}</td>
                                    @endif
                    ...
                    <td class="full-width">
                        <table class="result-table top-margin-spacer" style="width: 74%">
                            ...
                            <tr>
                                ...
                                <td class="text-center symbol">{{ $data->getCell('G40')->getFormattedValue() }}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
            ...
            <table class="top-margin-spacer">
                ...
                <tr><td class="full-width">{{ $data->getCell('B55')->getFormattedValue() }}</td></tr>
            </table>
            ...
            <table class="top-margin-spacer">
                ...
                <tr><td class="full-width">
                    {{ $data->getCell('B58')->getFormattedValue() }}
                </td></tr>
            </table>
            ...
            <table class="top-margin-spacer">
                ...
                <tr><td class="full-width">
                    {{ $data->getCell('B62')->getFormattedValue() }}
                </td></tr>
            </table>

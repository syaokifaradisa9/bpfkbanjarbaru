                ...
                <div class="mt-3">
                  <div class="row">
                    <div class="form-group col-2">
                      ...
                      <input name="E6" type="text" placeholder="Merek" class="form-control" value="{{ $excel_value['E6'] ?? '' }}">
                    </div>
                    <div class="form-group col-2">
                      <label><b>Tipe/Model Alat</b></label>
                      <input name="E7" type="text" placeholder="Tipe/Model" class="form-control" value="{{ $excel_value['E7'] ?? '' }}">
                    </div>
                    <div class="form-group col-2">
                      <label><b>Nomor Seri Alat</b></label>
                      <input name="E8" type="text" placeholder="Tipe/Model" class="form-control" value="{{ $excel_value['E8'] ?? '' }}">
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-3">
                      ...
                      <input name="E12" type="text" class="form-control" value="{{ $excel_value['E12'] ?? $alkesOrder->external_order->user->fasyenkes_name }}">
                    </div>
                    <div class="form-group col-3">

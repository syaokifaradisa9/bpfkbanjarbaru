                ...
                <div class="mt-3">
                  <div class="row">
                    <div class="form-group col">
                      ...
                      <input name="E5" type="text" placeholder="Merek" class="form-control" value="{{ $excel_value['E5'] ?? $alkesOrder->merk ?? '' }}">
                    </div>
                    <div class="form-group col">
                      <label><b>Tipe/Model Alat</b></label>
                      <input name="E6" type="text" placeholder="Tipe/Model" class="form-control" value="{{ $excel_value['E6'] ?? $alkesOrder->model ?? '' }}">
                    </div>
                    <div class="form-group col">
                      <label><b>Nomor Seri</b></label>
                      <input name="E7" type="text" placeholder="Nomor Seri" class="form-control" value="{{ $excel_value['E7'] ?? $alkesOrder->series_number ?? '' }}">
                    </div>
                    <div class="form-group col">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-3">
                      ...
                      <input name="E11" type="text" class="form-control" value="{{ $alkesOrder->external_order->user->fasyankes_name ?? 'Lab LPFK Banjarbaru' }}">
                    </div>
                    <div class="form-group col-3">

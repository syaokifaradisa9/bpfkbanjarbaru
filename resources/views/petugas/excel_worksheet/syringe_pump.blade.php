                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <select class="form-control" name="D49">
                        <option value="" disabled selected hidden>Syringe Merk</option>
                        @foreach (['Bbraun', 'Terumo', 'Otsuka', 'Onemed', 'GEA', 'Mindray', 'Fresenius', 'Others'] as $merkName)
                          <option value="{{ $merkName }}">{{ $merkName }}</option>
                        @endforeach
                      </select>
                    </div>
                    <div class="col">
                      <select class="form-control" name="D50">
                        <option value="" disabled selected hidden>Extend Tube Merk</option>
                        @foreach (['Bbraun', 'Terumo', 'Otsuka', 'Onemed', 'GEA', 'Mindray', 'Fresenius', 'Others'] as $merkName)
                          <option value="{{ $merkName }}">{{ $merkName }}</option>
                        @endforeach
                      </select>

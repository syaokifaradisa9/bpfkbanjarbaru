              ...
              <div class="card-body px-4">
                ...
                <div class="row mt-3">
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input name="D4" type="text" placeholder="Merek" class="form-control">
                      <input name="D5" type="text" placeholder="Tipe/Model" class="form-control mt-2">
                      <input name="D6" type="text" placeholder="Nomor Seri" class="form-control mt-2">
                      <div class="row mt-2 mx-0">
                        <input name="F7" type="text" placeholder="Resolusi" class="form-control col">
                  ...
                  <div class="form-group col">
                    ...
                    <div class="row mx-0">
                      <input name="D16" type="text" placeholder="Suhu Awal" class="form-control col">
                      <input name="E16" type="text" placeholder="Suhu Akhir" class="form-control col ml-3">
                    </div>
                    <div class="row mx-0 mt-2">
                      <input name="D17" type="text" placeholder="Kelembapan Awal" class="form-control col">
                      <input name="E17" type="text" placeholder="Kelembapan Akhir" class="form-control col ml-3">
                    </div>
                  </div>
                </div>
                ...
                <div class="row mt-3">
                  <div class="form-group col-3">
                    ...
                    <input name="D8" type="date" class="form-control" value="{{ date('Y-m-d', time()) }}">
                  </div>
                  <div class="form-group col-3">
                    <label><b>Tanggal Kalibrasi</b></label>
                    <input name="D9" type="date" class="form-control" value="{{ date('Y-m-d', time()) }}">
                  </div>
                  <div class="form-group col-3">
                    <label><b>Tempat Kalibrasi</b></label>
                    <input name="D10" type="text" class="form-control" value="{{ $alkesOrder->external_order->user->fasyenkes_name }}">
                  </div>
                  <div class="form-group col-3">
                    <label><b>Nama Ruang</b></label>
                    <input name="D11" type="text" class="form-control">
                  </div>
                </div>
                        ...
                        <tr>
                          ...
                          @foreach (['C', 'D', 'F', 'G'] as $letter)
                            <td class="text-center align-middle">
                              <input name="{{ $letter.($i + 29) }}" type="text" class="text-center form-control">
                            </td>
                          @endforeach
                        </tr>
                        @endfor
                      ...
                      @foreach ([1, 2, 3, 5, 10] as $index => $mass)
                        <tr>
                          ...
                          @foreach (['C', 'D', 'E', 'F'] as $letter)
                            <td class="text-center align-middle">
                              <input name="{{ $letter.$numCol[$index] }}" type="text" class="form-control text-center">
                            </td>
                          @endforeach
                        </tr>
                      @endforeach
                    ...
                    @for ($i = 1; $i <= 2; $i++)
                      <tr>
                        ...
                        @foreach (['C', 'D', 'E', 'F', 'G'] as $letter)
                          <td class="text-center align-middle">
                            <input name="{{ $letter.($i + 56) }}" type="text" class="form-control text-center">
                          </td>
                        @endforeach
                      </tr>
                    @endfor

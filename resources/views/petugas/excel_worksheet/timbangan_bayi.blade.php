    ...
    <form action="
      ...
      <div class="card-body px-4">
        ...
        <div class="mt-3">
          <div class="row">
            <div class="form-group col-2">
              ...
              <input name="D4" type="text" placeholder="Merek" class="form-control" value="{{ $excel_value['D4'] ?? $alkesOrder->merk ?? '' }}">
            </div>
            <div class="form-group col-2">
              <label><b>Tipe/Model Alat</b></label>
              <input name="D5" type="text" placeholder="Tipe/Model" class="form-control" value="{{ $excel_value['D5'] ?? $alkesOrder->model ?? '' }}">
            </div>
            <div class="form-group col-2">
              <label><b>Nomor Seri Alat</b></label>
              <input name="D6" type="text" placeholder="Tipe/Model" class="form-control" value="{{ $excel_value['D6'] ?? $alkesOrder->series_number ?? '' }}">
            </div>
            <div class="form-group col">
              ...
              <div class="row mx-0">
                ...
                <div class="col-5 text-center pt-2">
                  ...
                  <div class="custom-control custom-radio custom-control-inline">
                    <input name="F7" type="radio" id="digital" value="Digital" class="custom-control-input"
                    @if (isset($excel_value['F7']))
        ...
        <div class="form-group">
          ...
          <select name="B78" class="form-control">

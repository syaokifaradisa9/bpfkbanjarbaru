                ...
                <div class="mt-3">
                  <div class="row">
                    <div class="form-group col-2">
                      ...
                      <input name="C5" type="text" placeholder="Merek" class="form-control" value="{{ $excel_value['C5'] ?? '' }}">
                    </div>
                    <div class="form-group col-2">
                      <label><b>Tipe/Model Alat</b></label>
                      <input name="C6" type="text" placeholder="Tipe/Model" class="form-control" value="{{ $excel_value['C6'] ?? '' }}">
                    </div>
                    <div class="form-group col-2">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-3">
                      ...
                      <input name="C11" type="text" class="form-control" value="{{ $excel_value['C11'] ?? $alkesOrder->external_order->user->fasyenkes_name }}">
                    </div>
                    <div class="form-group col-3">

                ...
                <div class="mt-3">
                        ...
                        <select name="C7" class="form-control col">
                          <option value="(0 - 500) mL/h"
                            @if (isset($excel_value))
                              @if($excel_value['C7'] == "(0 - 500) mL/h") selected @endif
                            @endif>
                            (0 - 500) mL/h
                          </option>
                      ...
                      <div class="row ml-1">
                        <select name="C8" class="form-control col">
                          <option value="(100 - 500) mL/h"
                            @if (isset($excel_value))
                              @if($excel_value['C8'] == "(100 - 500) mL/h") selected @endif
                            @endif>
                            (100 - 500) mL/h
                          </option>
                          <option value="(100 - 300) mL/h"
                            @if (isset($excel_value))
                              @if($excel_value['C8'] == "(100 - 300) mL/h") selected @endif
                            @endif>
                            (100 - 300) mL/h
                          </option>
                        </select>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-3">
                      ...
                      <input name="E11" type="text" class="form-control" value="{{ $excel_value['E11'] ?? $alkesOrder->external_order->user->fasyankes_name ?? 'Lab LPFK Banjarbaru' }}">
                    </div>
                    <div class="form-group col-3">
                      ...
                      <select class="form-control" name="D49">
                        ...
                        @foreach (['Bbraun', 'Terumo', 'Otsuka', 'Onemed', 'GEA', 'Mindray', 'Fresenius'] as $merkName)
                            @foreach ([20, 60] as $dropNumber)
                                <option value="{{ $merkName }}, {{ $dropNumber }} drops"
                                  @if (isset($excel_value))
                                    @if($excel_value['D49'] == $merkName.', '.$dropNumber." drops") selected @endif
                                  @endif>
                                  {{ $merkName }}, {{ $dropNumber }} drops
                                </option>
                            @endforeach
                        @endforeach
                    </select>

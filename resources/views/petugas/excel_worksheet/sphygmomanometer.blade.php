        ...
        <div class="mt-3">
          <div class="row">
            <div class="form-group col">
              ...
              <input name="C6" type="text" placeholder="Merek" class="form-control" value="{{ $excel_value['C6'] ?? $alkesOrder->merk ?? '' }}">
            </div>
            <div class="form-group col">
              <label><b>Tipe/Model Alat</b></label>
              <input name="C7" type="text" placeholder="Tipe/Model" class="form-control" value="{{ $excel_value['C7'] ?? $alkesOrder->model ?? '' }}">
            </div>
            <div class="form-group col">
              <label><b>Nomor Seri</b></label>
              <input name="C8" type="text" placeholder="Nomor Seri" class="form-control" value="{{ $excel_value['C8'] ?? $alkesOrder->series_number ?? '' }}">
            </div>
            <div class="form-group col">
          ...
          <div class="row">
            ...
            <div class="form-group col-3">
              ...
              <input name="C12" type="text" class="form-control" value="{{ $excel_value['C12'] ?? $alkesOrder->external_order->user->fasyankes_name ?? 'Lab LPFK Banjarbaru' }}">
            </div>
            <div class="form-group col-3">

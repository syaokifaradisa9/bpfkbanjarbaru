  ...
  <div id="app">
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch ">
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="{{ asset("img/background/auth-bg.jpg") }}" style="background-size: cover">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 ">
              <div class="mb-5 pb-3">
                <h3 class="mb-2 display-4 font-weight-bold">LPFK Banjarbaru</h3>
